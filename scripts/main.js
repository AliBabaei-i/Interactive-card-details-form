...
const setError = (element, message) => {
    ...
    parentElement.querySelector("input").style.border = `1px solid${red}`;
};
...
const setErrorDatey = (element, message) => {
    ...
    // span.classList.add("error");
    span.style.visibility = "visible";
    parentElement.querySelector("#year").style.border = `1px solid${red}`;
};
...
const setErrorDatem = (element, message) => {
    ...
    // span.classList.add("error");
    span.style.visibility = "visible";
    parentElement.querySelector("#month").style.border = `1px solid${red}`;
};
